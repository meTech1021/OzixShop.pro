...
@section('page_js')
    <script src="{{ asset('js/buyer/account/learning.js') }}"></script>
@endsection
...
<div class="page-head">
    <div class="container">
        ...
        <div class="page-title">
            <h1>Accounts - Learning { udemy, lynda, .... etc. }</h1>
        </div>
        <!-- END PAGE TITLE -->
    </div>
</div>
            ...
            <div class="col-md-12">
                <div class="note note-default">
                    <ul>
                        ...
                        <li>There is <b>{{ count($datas) }}</b> Accounts [Learning { udemy, lynda, .... etc. }] Available.</li>
                    </ul>
                </div>
            </div>
        </div>
