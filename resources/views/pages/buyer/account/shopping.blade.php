...
@section('page_js')
    <script src="{{ asset('js/buyer/account/shopping.js') }}"></script>
@endsection
...
<div class="page-head">
    <div class="container">
        ...
        <div class="page-title">
            <h1>Accounts - Shopping {Amazon, eBay .... etc }</h1>
        </div>
        <!-- END PAGE TITLE -->
    </div>
</div>
            ...
            <div class="col-md-12">
                <div class="note note-default">
                    <ul>
                        ...
                        <li>There is <b>{{ count($datas) }}</b> Accounts [Shopping {Amazon, eBay .... etc }] Available.</li>
                    </ul>
                </div>
            </div>
        </div>
