...
@section('page_js')
    <script src="{{ asset('js/buyer/others/tutorials.js') }}"></script>
@endsection
            ...
            <div class="col-md-12">
                <div class="note note-default">
                    <ul>
                        ...
                        <li>There is <b>{{ count($datas) }}</b> Others [Tutorials/Methods] Available.</li>
                    </ul>
                </div>
            </div>
        </div>
