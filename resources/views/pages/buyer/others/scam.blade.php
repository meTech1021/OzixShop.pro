...
@section('page_js')
    <script src="{{ asset('js/buyer/others/scam.js') }}"></script>
@endsection
            ...
            <div class="col-md-12">
                <div class="note note-default">
                    <ul>
                        ...
                        <li>There is <b>{{ count($datas) }}</b> Others [Exploit/Script/ScamPage] Available.</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="portlet-body">
                ...
                <form method="get" id="filter_form">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label class="bold">Script Name :</label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-striped table-bordered table-hover" id="other_table">
                            <thead>
                                <tr>
                                    <th width="8%">Location</th>
                                    <th width="10%">Script Name</th>
                            ...
                            <tbody>
                                @foreach ($datas as $item)
                                    <tr>
                                        <td><i class="flag-icon flag-icon-{{ strtolower($item->country)}}"></i>{{ $item->country }}</td>
                                        <td>
                                            {{ $item->scam_name }}
                                        </td>
                                        <td>{{ $item->infos }}</td>
