...
@section('page_js')
<script src="{{ asset('js/buyer/send/smtp.js') }}"></script>
@endsection
    ...
    <div class="container">
            ...
            <div class="col-md-12">
                <div class="note note-default">
                    <ul>
                        ...
                        <li>There is <b>{{ count($smtps) }}</b> SMTP Available.</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="portlet light">
            <div class="portlet-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-striped table-bordered table-hover" id="smtp_table">
                            <thead>
                                <tr>
                                    <th width="5%">ID</th>
                            ...
                            <tbody>
                                @foreach ($smtps as $smtp)
                                    <tr>
                                        <td>{{ $smtp->id }}</td>
                                        <td>
                                            <i class="flag-icon flag-icon-{{ strtolower($smtp->country)}}"></i>{{ $smtp->country }}
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            seller{{ $smtp->seller_id }}
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-sm btn-primary btn_chk" smtp_id="{{ $smtp->id }}">Check</button>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-sm btn-danger btn_buy" data_id="{{ $smtp->id }}">Buy</button>
                                        </td>
