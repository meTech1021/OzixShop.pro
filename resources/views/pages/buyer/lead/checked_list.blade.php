...
@section('page_js')
    <script src="{{ asset('js/buyer/lead/checked_list.js') }}"></script>
@endsection
...
<div class="page-head">
    <div class="container">
        ...
        <div class="page-title">
            <h1>Leads - 100% Checked Email list</h1>
        </div>
        <!-- END PAGE TITLE -->
    </div>
</div>
    ...
    <div class="container">
            ...
            <div class="col-md-12">
                <div class="note note-default">
                    <ul>
                        ...
                        <li>There is <b>{{ count($checked_list) }}</b> 100% Checked Email list Lists Available.</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="portlet light">
            <div class="portlet-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-striped table-bordered table-hover" id="checked_table">
                            <thead>
                                <tr>
                                    <th width="8%">Location</th>
                                    <th width="22%">Description</th>
                                    <th width="8%">Emails Number</th>
