...
@section('page_js')
<script src="{{ asset('js/seller/management/scam.js') }}"></script>
@endsection
        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green-sharp bold uppercase">Exploit/Script/ScamPage Management</span>
                </div>
                <div class="tools">
                    ...
                    <ul class="nav nav-tabs ">
                        ...
                        <li>
                            <a href="#tab_all" data-toggle="tab">
                                List
                                <span class="badge badge-danger" id="scams_badge"> {{ count($scams) }} </span>
                            </a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane active" id="tab_static">
                            <div class="row">
                                <div class="col-md-12 rules">
                                    ...
                                    <ul>
                                        <li><span class="label label-danger">IMPORTANT</span> Make sure to include a screenshot for each Script, and make sure it's not backdoored (Backdoor = Ban)</li>
                            ...
                            <table class="table table-striped table-hover table-bordered" id="scam_table">
                                ...
                                <tbody>
                                    @foreach ($scams as $scam)
                                        <tr>
                                            <td>{{ $scam->id }}</td>
                                            <td><label>{{ $scam->acctype }}</label></td>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title bold text-danger"><i class="fa fa-file font-red-sharp"></i> New Scam</h4>
            </div>
            <div class="modal-body">
                <form action="javascript:;" id="scam_form" novalidate="novalidate">
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Scam Name <span class="required" aria-required="true">
                                    * </span>
                                    </label>
                                    <input type="text" class="form-control" name="name" id="name" placeholder="scam Name">
                                </div>
                                <div class="form-group">
