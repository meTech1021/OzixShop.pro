...
@section('page_js')
<script src="{{ asset('js/seller/management/leads.js') }}"></script>
@endsection
...
<!-- BEGIN PAGE HEADER-->
<h3 class="page-title">
    100% Checked Email List / Email-list / Combo List
</h3>
<!-- END PAGE HEADER-->
        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green-sharp bold uppercase">Leads Management</span>
                </div>
                <div class="tools">
                    ...
                    <ul class="nav nav-tabs ">
                        ...
                        <li>
                            <a href="#tab_all" data-toggle="tab">
                                Lead List
                                <span class="badge badge-danger" id="leads_badge"> {{ count($leads) }} </span>
                            </a>
                        </li>
                    </ul>
                            ...
                            <div class="row">
                                <div class="col-md-12 rules">
                                    ...
                                    <ul>
                                        ...
                                        <li>You can choose the price you want but the usual is <label class="text-danger bold">2</label><label class="text-primary">$</label> ~ <label class="bold text-danger">5</label><label class="text-primary">$</label> per 10k</li>
                                    ...
                                    <ul>
                                        <li>Number of Leads : <b class="text-primary" id="lead_cnt">{{ count($leads) }}</b></li>
                                        <li>Unsold Leads : <b class="text-primary" id="unsold_cnt">{{ $unsold_cnt }}</b></li>
                                        <li>Sold Leads : <b class="text-primary">{{ $sold_cnt }}</b></li>
                                        <li>Deleted Leads : <b class="text-primary" id="deleted_cnt">{{ $deleted_cnt }}</b></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title bold text-danger"><i class="fa fa-envelope font-red-sharp"></i> New Lead</h4>
            </div>
            <div class="modal-body">
                <form action="javascript:;" id="lead_form" novalidate="novalidate">
                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    * </span>
                                    ...
                                    <textarea class="form-control" name="infos" id="infos" placeholder="HOTMAIL / From Shopping" rows="1"></textarea>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Lead Type <span class="required" aria-required="true">
                                        * </span></label>
                                        <select class="form-control" name="type" id="type">
                                            <option value="">Select Lead Type</option>
                                            <option value="checked_list">100% Checked Email List</option>
                                            <option value="email_list">Email List</option>
                                            <option value="combo_list">Combo List</option>
                                        </select>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Email Number <span class="required" aria-required="true">
                                    * </span>
                                    </label>
                                    <input type="number" class="form-control" name="number" id="number" placeholder="10k">
                                </div>
                                <div class="form-group">
