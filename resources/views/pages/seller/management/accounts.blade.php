...
@section('page_js')
<script src="{{ asset('js/seller/management/accounts.js') }}"></script>
@endsection
        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green-sharp bold uppercase">Accounts Management</span>
                </div>
                <div class="tools">
                    ...
                    <ul class="nav nav-tabs ">
                        ...
                        <li>
                            <a href="#tab_all" data-toggle="tab">
                                Account List
                                <span class="badge badge-danger" id="accounts_badge"> {{ count($accounts) }} </span>
                            </a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane active" id="tab_static">
                            <div class="row">
                                <div class="col-md-12 rules">
                                    ...
                                    <ul>
                                        <li>Number of Accounts : <b class="text-primary" id="account_cnt">{{ count($accounts) }}</b></li>
                                        <li>Unsold Accounts : <b class="text-primary" id="unsold_cnt">{{ $unsold_cnt }}</b></li>
                                        <li>Sold Accounts : <b class="text-primary">{{ $sold_cnt }}</b></li>
                                        <li>Deleted Accounts : <b class="text-primary" id="deleted_cnt">{{ $deleted_cnt }}</b></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-hover table-bordered" id="account_table">
                                ...
                                <tbody>
                                    @foreach ($accounts as $account)
                                        <tr>
                                            <td>{{ $account->id }}</td>
                                            <td><label>{{ $account->acctype }}</label></td>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title bold text-danger"><i class="icon-users font-red-sharp"></i> New account</h4>
            </div>
            <div class="modal-body">
                <form action="javascript:;" id="account_form" novalidate="novalidate">

                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Website Name <span class="required" aria-required="true">
                                    * </span>
                                    </label>
                                    <input type="url" class="form-control" name="sitename" id="sitename" placeholder="site.com">
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Available Information <span class="required" aria-required="true">
                                    * </span>
                                    </label>
                                    <textarea class="form-control" name="infos" id="infos" placeholder="Fresh paid account / expiration / etc ..." rows="1"></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label">Source <span class="required" aria-required="true">
                                    * </span>
                                    </label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">account Type <span class="required" aria-required="true">
                                        * </span></label>
                                        <select class="form-control" name="type" id="type">
                                            ...
                                            <option value="vpn">VPN/Socks Proxy</option>
                                            <option value="shopping">Shopping {Amazon, eBay .... etc }</option>
                                            <option value="stream">Stream { Music, Netflix, iptv, HBO, bein sport, WWE ...etc }</option>
                                            <option value="dating">Dating</option>
                                            <option value="learning">Learning { udemy, lynda, .... etc. }</option>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label">ALL ACCOUNT INFO HERE <span class="required" aria-required="true">
                                    * </span>
                                    </label>
                                    <textarea class="form-control" name="url" id="url" placeholder="User : XXXXXXX | Pass : XXXXXXX" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
