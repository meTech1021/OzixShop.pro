            ...
            success : function(data) {
                ...
                if(datas.length > 0) {
                    datas.forEach(data => {
                        ...
                        OtherTable.fnAddData([location, data.tutorial_name, data.infos, price, `seller${data.seller_id}`, proof_btn, buy_btn, data.created_at]);
