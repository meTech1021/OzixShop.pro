$(document).ready(function() {
    ...
    $('#reply').keydown(function(e) {
        ...
        if (keyCode === 13 && !e.shiftKey) {
            ...
            if($(this).val() != ''){
                ...
                $(this).val('');
                $.ajax({
                    url : '/seller/main/myreports/reply',
                    method : 'post',
                    data : {
                        report_id : report_id,
                        message : msg
                    ...
                    success : function(data) {
                        ...
                        var msg_html = `<div class="panel panel-default" style="border : 1px solid #00bbb1!important;"><div class="panel-body"><div class="report"><b>${msg}</b></div></div><div class="panel-footer"><div class="label label-success">Seller${seller_id}</div> - ${data.date}</div></div>`
    ...
    $('#btn_refund').click(function() {
        ...
        $.ajax({
            url : '/seller/main/myreports/refund',
            method : 'post',
            data : {
                report_id : report_id
            },
